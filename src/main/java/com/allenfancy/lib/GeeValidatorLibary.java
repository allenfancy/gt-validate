...
public class GeeValidatorLibary {

	protected final String versionName = "3.1.0";
	protected final String sdkLanguage = "JAVA";
	 ...
	 * @param privateKey
	 */
	public GeeValidatorLibary(String captchaId, String privateKey) {
	...
	public int enhencedValidateRequest(String challenge, String validate, String seccode) {
		...
		int port = 80;
		String query = String.format("seccode=%s&sdk=%s", seccode, (this.sdkLanguage + "_" + this.versionName));
		String response = "";
	...
	public int failbackValidateRequest(String challenge, String validate, String seccode) {
		...
		gtlog(String.format("encode----challenge:%s--ans:%s,bg_idx:%s,grp_idx:%s", challenge, encodeAns,
				encodeFullBgImgIndex, encodeImgGrpIndex));
